...
import AddEditNewsCategory from "./addEdit";
...
const AddNewsCategory = async ({ params }: any) => {
  ...
  return (
    <>
      <PageHeader
        title={isEdit ? "Update News Category" : "Add News Category"}
        showBack
      />
      <FormContainer>
        <AddEditNewsCategory token={token} data={data} isEdit={isEdit} id={id} />
      </FormContainer>
    </>
  );
};

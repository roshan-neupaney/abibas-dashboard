...
const DashboardLayout = ({ children }: any) => {
  return (
    <div className="flex w-screen min-h-screen flex-col lg:flex-row">
      <div className="lg:min-w-220 h-screen sticky top-0 left-0 overflow-auto noScrollBar hidden lg:flex z-50">
        <Sidebar />
      </div>
      <div className="flex flex-1 flex-col w-full lg:w-[calc(100%-250px)] ">
        <TopHeader />
